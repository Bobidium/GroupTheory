...
$$
1 = H_0 \unlhd H_1 \unlhd ... \unlhd H \unlhd G
$$
where each coposition factor in the series is simple and abelian, so is hence cyclic of prime order. By the [[Composition Series and the Hölder Program#Jordan-Hölder Theorem and the Hölder Program|Jordan-Hölder Theorem]], this implies that all composition factors of $G$ are cyclic or prime orders. 